...
/**
 * Returns a GLSL shader responsible for the core logic
 * that makes a sphere ripple in a pseudo-random way.
 * REFERENCE: https://www.shadertoy.com/view/td33Rj
 * @param webglVersion Determines which GLSL is to be returned based on the enabled WebGL version.
 */
export const fractals = (webglVersion: number) => {
